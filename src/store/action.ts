...
export const addUserIdData = createAction(
  ActionType.ADD_USER_ID_DATA,
  (newUserIdData) => ({
...
export const addUserAuthData = createAction(
  ActionType.ADD_USER_AUTH_DATA,
  (userAuthData: AuthData) => ({
    payload: userAuthData,
  })
);

export const addNewTokens = createAction(
  ActionType.ADD_NEW_TOKENS,
  (newTokens: { token: string; refreshToken: string }) => ({
    payload: newTokens,
  })
);
...
export const resetStore = createAction(
  ActionType.RESET_STORE,
  (initialState: State) => ({
    payload: initialState,
  })
);

export const addTextbookState = createAction(
  ActionType.ADD_TEXTBOOK_STATE,
